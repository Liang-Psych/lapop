...
state_city <- read_dta("Brazil_2014.dta") %>% 
...
bra_lapop_14 <- read_dta('Brazil_2014.dta') %>%
...
rm(list = setdiff(ls(), c("bra_lapop_14","bra_lapop_17","bra_lapop_19","bra_lapop_21","bra_lapop_23")))
